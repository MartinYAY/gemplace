...
User.init = function () {
    ...
    console.log('Loaded avatar list');
...
User.assert = function (assertion, callback) {
    ...
    if (process.argv.hasOwnProperty('2') && process.argv[2] === '--debug') {
        ...
        postdata = 'assertion=' + assertion + '&audience=http://jarl.sytes.net';
    }
...
User.getAvatarInventory = function (nick) {
    return this.getUserData(nick, 'avatarInventory', ['babywatermelon']);
};
